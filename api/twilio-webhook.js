 ...
 * Updated: Process missed calls on any call status (busy, no-answer, completed, etc.)
 */
...
module.exports = async (req, res) => {
  ...
  try {
    ...
    // Check if call was missed (duration < 2 seconds = no answer)
    ...
    console.log(`[${CallSid}] Missed call detected (${callDurationSeconds}s). Sending SMS to ${From}...`);
